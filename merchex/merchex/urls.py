...
urlpatterns = [
    ...
    path('groupes/', views.band_list, name='band-list'),
    path('groupes/<int:id>/',views.band_detail, name='band-detail'),
    path('groupes/add/', views.band_create, name='band-create'),
    path('groupes/<int:id>/change', views.band_change, name='band-change'),
    path('groupes/<int:id>/delete', views.band_delete, name='band-delete'),
